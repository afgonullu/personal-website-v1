...
const SectionServices: React.FC = (props) => {
  const copyText = {
    title: "Services",
    text:
      "I can provide end to end development, or spesific services according to project requirements. You can see the services I offer throughout the development lifecycle here. Click them for more information.",
  }

  return (
    <section className="section-services d-flex justify-content-center flex-column">
      <SectionHeader
      ...
      <div className="services-icons d-flex justify-content-center flex-wrap">
        ...
        <a href="/workflow#solution-design">
          <div className="d-flex flex-column justify-content-center align-items-center p-3 m-3">
            <svg
              width="2.441em"
              height="2.441em"
